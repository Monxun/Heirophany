...
#  docker tag 266edf5ddffd us-west1-docker.pkg.dev/ml-pipeline-348219/pipeline-images/pipeline-image:tag1
#  docker push us-west1-docker.pkg.dev/ml-pipeline-348219/pipeline-images/pipeline-image:tag1
# 35.185.233.57

# kubectl create deployment insurance-app --image=us-west1-docker.pkg.dev/ml-pipeline-348219/pipeline-images/pipeline-image:tag1