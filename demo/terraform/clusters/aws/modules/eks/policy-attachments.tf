resource "aws_iam_role_policy_attachment" "AmazonEKSClusterPolicy" {
  # Attach the EKS Cluster Policy to the eks cluster iam role
...
resource "aws_iam_role_policy_attachment" "AmazonEKSCloudWatchMetricPolicy" {
  policy_arn = aws_iam_policy.AmazonEKSClusterCloudWatchMetricPolicy.arn
  role       = aws_iam_role.eks_cluster_role.name
}
...
#AWS EKS VPC Rss Controller Policy 
